    ...
    setTimeout(() => {
        ...
        installBtn.innerHTML = `
            <div style="position:fixed;bottom:20px;left:50%;transform:translateX(-50%);z-index:9999;
                        background:linear-gradient(135deg,#1a1a1a,#2d2d2d);color:white;padding:12px 24px;
                        border-radius:30px;box-shadow:0 4px 15px rgba(204,0,0,0.4);cursor:pointer;
                        font-family:Arial;font-size:14px;text-align:center;border:2px solid #CC0000;">
                📱 Install Churchgate HRIS App
            </div>
        `;
